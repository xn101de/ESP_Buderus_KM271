...
// ======================================================================================
struct s_err_array {
  const char *idx[2][215] = {{// GERMAN
                             "Kein Fehler",
                             "Strategievorlauffuehler defekt",
                             "Aussenfuehler defekt",
                             "HK1-Vorlauffuehler defekt",
                             "HK2-Vorlauffuehler defekt",
                             "HK3-Vorlauffuehler defekt",
                             "HK4-Vorlauffuehler defekt",
                             "nicht belegt",
                             ...
                             "HK3-Fernbedienung defekt",
                             "HK4-Fernbedienung defekt",
                             "Keine Kommunikation mit HK1-Fernbedienung",
                             "Keine Kommunikation mit HK2-Fernbedienung",
                             "Keine Kommunikation mit HK3-Fernbedienung",
                             "Keine Kommunikation mit HK4-Fernbedienung",
                             "nicht belegt",
                             "Stoerung Brenner 1",
                             "Stoerung Brenner 2",
                             "Stoerung Brenner 3",
                             ...
                             "Keine Verbindung mit Kessel 2",
                             "Keine Verbindung mit Kessel 3",
                             "nicht belegt",
                             "nicht belegt",
                             "nicht belegt",
                             ...
                             "HK5-Vorlauffuehler defekt",
                             "HK6-Vorlauffuehler defekt",
                             "HK7-Vorlauffuehler defekt",
                             "HK8-Vorlauffuehler defekt",
                             "nicht belegt",
                             "HK5-Fernbedienung defekt",
                             "HK6-Fernbedienung defekt",
                             "HK7-Fernbedienung defekt",
                             "HK8-Fernbedienung defekt",
                             "nicht belegt",
                             "Keine Kommunikation mit HK5-Fernbedienung",
                             "Keine Kommunikation mit HK6-Fernbedienung",
                             "Keine Kommunikation mit HK7-Fernbedienung",
                             "Keine Kommunikation mit HK8-Fernbedienung",
                             "nicht belegt",
                             ...
                             "Externer Stoereingang (Pumpe) HK1",
                             "Externer Stoereingang (Pumpe) HK2",
                             "Externer Stoereingang (Pumpe) HK3",
                             "Externer Stoereingang (Pumpe) HK4",
                             "Externer Stoereingang (Pumpe) HK5",
                             "Externer Stoereingang (Pumpe) HK6",
                             "Externer Stoereingang (Pumpe) HK7",
                             "Externer Stoereingang (Pumpe) HK8",
                             "nicht belegt",
                             "Interner Fehler Nr. 5",
                             "Interner Fehler Nr. 6",
                             "Interner Fehler Nr. 7",
                             "Interner Fehler Nr. 8",
                             "Kein Master (Adr. 1) vorhanden",
                             "Adresskonflikt auf CAN-Bus",
                             "Adresskonflikt auf Steckplatz 1",
                             "Adresskonflikt auf Steckplatz 2",
                             "Adresskonflikt auf Steckplatz 3",
                             "Adresskonflikt auf Steckplatz 4",
                             "Adresskonflikt auf Steckplatz A",
                             "Falsches Modul auf Steckplatz 1",
                             "Falsches Modul auf Steckplatz 2",
                             "Falsches Modul auf Steckplatz 3",
                             "Falsches Modul auf Steckplatz 4",
                             "Falsches Modul auf Steckplatz A",
                             "Unbekanntes Modul auf Steckplatz 1",
                             "Unbekanntes Modul auf Steckplatz 2",
                             "Unbekanntes Modul auf Steckplatz 3",
                             "Unbekanntes Modul auf Steckplatz 4",
                             "Unbekanntes Modul auf Steckplatz A",
                             "Ruecklauffuehler defekt",
                             "Ext. Stoereingang (Inertanode) WW",
                             "Ext. Stoereingang (Pumpe) WW",
                             "Konfig. Ruecklauf bei Strategie",
                             "Konfig. Vorlauf bei Strategie",
                             "RESET",
                             ...
                             "Handschalter LAP Primaerpumpe",
                             "Handschalter LAP Sekundaerpumpe",
                             "Waermetauscherfuehler LAP defekt",
                             "Speicher unten Fuehler LAP defekt",
                             "Warmwasser Solarfuehler defekt",
                             "Kollektorfuehler defekt",
                             "Stoerung Brenner 5",
                             "Stoerung Brenner 6",
                             "Stoerung Brenner 7",
                             "Stoerung Brenner 8",
                             ...
                             "Flaschenvorlauffuehler defekt",
                             "3-Wegeumschaltventil defekt",
                             "Fuellstand: Grenze unterschritten",
                             "Unterstation Waerme Unterversorgung",
                             "Unterstation Vorlauffuehler defekt",
                             "Kollektorfuehler defekt",
                             "Bypass-Ruecklauffuehler defekt",
                             "Bypass-Vorlauffuehler defekt",
                             "Waermemengenzaehler Vorlauf defekt",
                             "Waermemengenzaehler Ruecklauf defekt",
                             "Speicher 1 Fuehler unten defekt",
                             "Speicher 2 Fuehler unten defekt",
                             "Waermemengenzaehler Volumenstrommesser",
                             "Fehlerhafte Einstellung Solarmodul",
                             "Heizkreis 1 EIB-Fehler",
                             "Heizkreis 2 EIB-Fehler",
                             "Heizkreis 3 EIB-Fehler",
                             "Heizkreis 4 EIB-Fehler",
                             "Heizkreis 5 EIB-Fehler",
                             "Heizkreis 6 EIB-Fehler",
                             "Heizkreis 7 EIB-Fehler",
                             "Heizkreis 8 EIB-Fehler",
                             "Heizkreis 9 EIB-Fehler",
                             "Allgemeiner EIB-Fehler",
                             "Blockierender Fehler UBA",
                             "Verriegelnder Fehler UBA",
                             "Handbetrieb Solar Speicher 1",
                             "Handbetrieb Solar Speicher 2",
                             "Handbetrieb Heizkreis 0",
                             "Wartung erforderlich (Betriebsstunden)",
                             "Wartung erforderlich (Datum)",
                             "Warmwasser ist kalt",
                             "Handbetrieb Zubringerpumpe (PZB)",
                             "Handbetrieb EMS - Kessel 1",
                             "Handbetrieb EMS - Kessel 2",
                             "Handbetrieb EMS - Kessel 3",
                             "Handbetrieb EMS - Kessel 4",
                             "Handbetrieb EMS - Kessel 5",
                             "Handbetrieb EMS - Kessel 6",
                             "Handbetrieb EMS - Kessel 7",
                             "Handbetrieb EMS - Kessel 8",
                             "Stoerung EMS - Kessel 1",
                             "Stoerung EMS - Kessel 2",
                             "Stoerung EMS - Kessel 3",
                             "Stoerung EMS - Kessel 4",
                             "Stoerung EMS - Kessel 5",
                             "Stoerung EMS - Kessel 6",
                             "Stoerung EMS - Kessel 7",
                             "Stoerung EMS - Kessel 8",
                             "Stoerung EMS - Warmwasser",
                             "Wartung erforderlich EMS - Kessel 1",
                             "Wartung erforderlich EMS - Kessel 2",
                             "Wartung erforderlich EMS - Kessel 3",
                             "Wartung erforderlich EMS - Kessel 4",
                             "Wartung erforderlich EMS - Kessel 5",
                             "Wartung erforderlich EMS - Kessel 6",
                             "Wartung erforderlich EMS - Kessel 7",
                             "Wartung erforderlich EMS - Kessel 8",
                             "Alternativer WE Pumpe im Handbetrieb",
                             "Alternativer WE im Handbetrieb",
                             "Alternativer WE Ruecklauffuehler defekt",
                             "Alternativer WE Vorlauffuehler defekt",
                             "Alternativer WE Fuehler Puffer mitte",
                             "Alternativer WE Fuehler Puffer unten",
                             "Alternativer WE Fuehler Puffer oben",
                             "Alternativer WE Anlagen-Ruecklauffuehler",
                             "Alternativer WE Abgasfuehler defekt",
                             "Alternativer WE Kommunikation Brennerautomat",
                             "Alternativer WE Brennerautomat verriegelt",
                             "Alternativer WE Notkuehlung ausgeloest",
                             "FM458 Zuordnung Kessel 1",
                             "FM458 Zuordnung Kessel 2",
                             "FM458 Zuordnung Kessel 3",
                             "FM458 Zuordnung Kessel 4",
                             "FM458 Zuordnung Kessel 5",
                             "FM458 Zuordnung Kessel 6",
                             "FM458 Zuordnung Kessel 7",
                             "FM458 Zuordnung Kessel 8",
                             "FM458 Keine Verbindung zu Kessel 1",
                             "FM458 Keine Verbindung zu Kessel 2",
                             "FM458 Keine Verbindung zu Kessel 3",
                             "FM458 Keine Verbindung zu Kessel 4",
                             "FM458 Keine Verbindung zu Kessel 5",
                             "FM458 Keine Verbindung zu Kessel 6",
                             "FM458 Keine Verbindung zu Kessel 7",
                             "FM458 Keine Verbindung zu Kessel 8",
                             "FM458 Fuehler Vorlauf Strategie",
                             "FM458 Fuehler Ruecklauf Strategie",
                             "FM458 Konfiguration Ruecklauf Strategie",
                             "FM458 Konfiguration Vorlauf Strategie",
                             "FM458 Leistungsangabe fuer Kessel fehlt",
                             "unbekannter Fehler"},
                            {// ENGLISH
                             "no error",
                             "failure strategy flow sensor",
                             "failure outdoor sensor",
                             "failure hc1-flow sensor",
                             "failure hc2-flow sensor",
                             "failure hc3-flow sensor",
                             "failure hc4-flow sensor",
                             "not assigned",
                             "failure warm water sensor",
                             "Warm Water remains cold",
                             "Fault thermal disinfection",
                             "Fault hc1-remotecontrol",
                             "Fault hc2-remotecontrol",
                             "Fault hc3-remotecontrol",
                             "Fault hc4-remotecontrol",
                             "no communication to hc1-remote control",
                             "no communication to hc2-remote control",
                             "no communication to hc3-remote control",
                             "no communication to hc4-remote control",
                             "not assigned",
                             "Fault Burner 1",
                             "Fault Burner 2",
                             "Fault Burner 3",
                             ...
                             "no connection with boiler 2",
                             "no connection with boiler 3",
                             "not assigned",
                             "not assigned",
                             "not assigned",
                             "internal Error Nr. 1",
                             ...
                             "internal Error Nr. 3",
                             "internal Error Nr. 4",
                             "failure hc5-flow sensor",
                             "failure hc6-flow sensor",
                             "failure hc7-flow sensor",
                             "failure hc8-flow sensor",
                             "not assigned",
                             "Fault hc5-remotecontrol",
                             "Fault hc6-remotecontrol",
                             "Fault hc7-remotecontrol",
                             "Fault hc8-remotecontrol",
                             "not assigned",
                             "no communication to hc5-remote control",
                             "no communication to hc6-remote control",
                             "no communication to hc7-remote control",
                             "no communication to hc8-remote control",
                             "not assigned",
                             ...
                             "external fault input (pump) hc1",
                             "external fault input (pump) hc2",
                             "external fault input (pump) hc3",
                             "external fault input (pump) hc4",
                             "external fault input (pump) hc5",
                             "external fault input (pump) hc6",
                             "external fault input (pump) hc7",
                             "external fault input (pump) hc8",
                             "not assigned",
                             "internal Error Nr. 5",
                             "internal Error Nr. 6",
                             "internal Error Nr. 7",
                             "internal Error Nr. 8",
                             "no master (address 1) present",
                             "address conflict on CAN bus",
                             "address conflict on slot 1",
                             "address conflict on slot 2",
                             "address conflict on slot 3",
                             "address conflict on slot 4",
                             "address conflict on slot A",
                             "wrong module on slot 1",
                             "wrong module on slot 2",
                             "wrong module on slot 3",
                             "wrong module on slot 4",
                             "wrong module on slot A",
                             "unknown module on slot 1",
                             "unknown module on slot 2",
                             "unknown module on slot 3",
                             "unknown module on slot 4",
                             "unknown module on slot A",
                             "failure Return flow sensor",
                             "external fault input (anode) warm water",
                             "external fault input (pump) warm water",
                             "configuration return flow at strategy",
                             "configuration flow at strategy",
                             "RESET",
                             "manual switch heating circuit 1",
                             "manual switch heating circuit 2",
                             "manual switch heating circuit 3",
                             "manual switch heating circuit 4",
                             "manual switch heating circuit 5",
                             "manual switch heating circuit 6",
                             "manual switch heating circuit 7",
                             "manual switch heating circuit 8",
                             "manual switch warm water",
                             "manual switch burner",
                             "manual switch boiler circuit",
                             "strategy module missing",
                             "manual switch LAP primary pump",
                             "manual switch LAP secondary pump",
                             "failure LAP heat exchanger sensor",
                             "failure LAP storage bottom sensor",
                             "failure warm water solar sensor",
                             "failure collector sensor",
                             "Fault Burner 5",
                             "Fault Burner 6",
                             "Fault Burner 7",
                             "Fault Burner 8",
                             "no connection with burner control unit 1",
                             "no connection with burner control unit 2",
                             "no connection with burner control unit 3",
                             "no connection with burner control unit 4",
                             "no connection with burner control unit 5",
                             "no connection with burner control unit 6",
                             "no connection with burner control unit 7",
                             "no connection with burner control unit 8",
                             "failure cylinder flow sensor",
                             "failure 3-way diverter valve",
                             "fill level below limit",
                             "substation heat undersupply",
                             "failure substation flow sensor",
                             "failure collector sensor",
                             "failure bypass return sensor",
                             "failure bypass flow sensor",
                             "failure heat meter flow sensor",
                             "failure heat meter return sensor",
                             "failure storage 1 bottom sensor",
                             "failure storage 2 bottom sensor",
                             "heat meter flow rate sensor fault",
                             "incorrect solar module setting",
                             "heating circuit 1 EIB fault",
                             "heating circuit 2 EIB fault",
                             "heating circuit 3 EIB fault",
                             "heating circuit 4 EIB fault",
                             "heating circuit 5 EIB fault",
                             "heating circuit 6 EIB fault",
                             "heating circuit 7 EIB fault",
                             "heating circuit 8 EIB fault",
                             "heating circuit 9 EIB fault",
                             "general EIB fault",
                             "blocking fault UBA",
                             "locking fault UBA",
                             "manual operation solar storage 1",
                             "manual operation solar storage 2",
                             "manual operation heating circuit 0",
                             "maintenance required (operating hours)",
                             "maintenance required (date)",
                             "warm water is cold",
                             "manual operation feed pump (PZB)",
                             "manual operation EMS boiler 1",
                             "manual operation EMS boiler 2",
                             "manual operation EMS boiler 3",
                             "manual operation EMS boiler 4",
                             "manual operation EMS boiler 5",
                             "manual operation EMS boiler 6",
                             "manual operation EMS boiler 7",
                             "manual operation EMS boiler 8",
                             "Fault EMS boiler 1",
                             "Fault EMS boiler 2",
                             "Fault EMS boiler 3",
                             "Fault EMS boiler 4",
                             ...
                             "Fault EMS boiler 7",
                             "Fault EMS boiler 8",
                             "Fault EMS warm water",
                             "maintenance required EMS boiler 1",
                             "maintenance required EMS boiler 2",
                             "maintenance required EMS boiler 3",
                             "maintenance required EMS boiler 4",
                             "maintenance required EMS boiler 5",
                             "maintenance required EMS boiler 6",
                             "maintenance required EMS boiler 7",
                             "maintenance required EMS boiler 8",
                             "alternative heat source pump in manual mode",
                             "alternative heat source in manual mode",
                             "failure alternative heat source return sensor",
                             "failure alternative heat source flow sensor",
                             "failure alternative heat source buffer sensor middle",
                             "failure alternative heat source buffer sensor bottom",
                             "failure alternative heat source buffer sensor top",
                             "failure alternative heat source system return sensor",
                             "failure alternative heat source exhaust sensor",
                             "alternative heat source burner control unit communication fault",
                             "alternative heat source burner control unit locked",
                             "alternative heat source emergency cooling triggered",
                             "FM458 assignment boiler 1",
                             "FM458 assignment boiler 2",
                             "FM458 assignment boiler 3",
                             "FM458 assignment boiler 4",
                             "FM458 assignment boiler 5",
                             "FM458 assignment boiler 6",
                             "FM458 assignment boiler 7",
                             "FM458 assignment boiler 8",
                             "FM458 no connection to boiler 1",
                             "FM458 no connection to boiler 2",
                             "FM458 no connection to boiler 3",
                             "FM458 no connection to boiler 4",
                             "FM458 no connection to boiler 5",
                             "FM458 no connection to boiler 6",
                             "FM458 no connection to boiler 7",
                             "FM458 no connection to boiler 8",
                             "FM458 flow sensor strategy",
                             "FM458 return sensor strategy",
                             "FM458 configuration return strategy",
                             "FM458 configuration flow strategy",
                             "FM458 boiler output rating missing",
                             "unknown error"}};
};
